...
| premium| a high value or a value in excess of that normally or usually expected; an extra payment added to the basic rate |
|corollary | something that naturally follows or results from another thing|
| dearth|an inadequate supply |
|algae |primitive organisms lacking true stems and roots and leaves |
...
|dread|to fear greatly; one causing fear or awe |
...
| usurp|to take and keep (something, such as power) in a forceful or violent way |
| resonate| to produce or exhibit resonance; to affect or approval to someone in a personal or emotional way|
| rue| to feel penitence, remorse, or regret for|
| strew| to cover by or as if by scattering something|
...
| concede| to say that you accept or do not deny the truth or existence of; to give something away, especially unwillingly; to allow somebody to have something|
...
| vindicate| to prove that something is true; to clear of accusation, blame, suspicion, or doubt with supporting arguments or proof|
| jettison| to get rid of as superfluous or encumbering|
...
|ordain |to invest officially (as by the laying on of hands) with ministerial or priestly authority; to establish or order by appointment, decree, or law: encat | 
|percolate| to ooze or trickle through a permeable substance |
| resort|a place where a lot of people go on holiday; to have reourse |
...
|nominal |existing as something in name only: not actual or real; trifling, insignificant |
| repugnant|exciting distaste or aversion |
| puerile| childish, silly|
| supple|moving and bending with ease; readily adaptable or responsive to new situations |
| obligatory| mandatory, required; always or often included as a familiar and expected part of something|
| bogus| not real or genuine|
| clinical| of , relating to, or conducted in or as if in a clinic; analytical or coolly dispassionate|
|   covert| made, shown, or done in a way that is not easily seen or noticed |
|fortuitous | happening by a fortunate accident or change|
| requisite| essential, necessary; a thing that is necessary for the achievement of a specified end|
...
|anachronistic |out of date or old-fashioned; something that is mistakenly placed in a time where is does not blong in a story, moive, etc. |
|unwitting |not intended or planned |
| dogmatic|expressing personal opinions or beliefs as if they are certainly correct and canis not be doubted |
...
| imperative| very important; pressing; expressing a command or plea; peremptory; a thing that very important and needs immediate attention or action|
...
| arid|excessively dry; specifically: having insufficient rainfall to support agriculture; lacking in interest and life |
...
| blunt| having a thick edge or point; being straight to the point |
| perpetual| continuing forever|
| expedient|suitable for achieving a particular end in a given circumstance; a temporary means to an end |
| tangent|divering from an original purpose or course; meeting a curve or surface in a single point if a sufficiently small interval is considered| 
| resilient|capable of returning to an original shape or position, as after having been compressed; tending to recover from or adjust easily to misfortune or change |
...
| igneous|formed when magma becomes solid, especially after it has poured out of a volcano |
| impartial| not partial or biased|
| upbeat|cheerful, optimistic |
| pious| marked by or showing reverence for deity and devotion to devine worship; marked by self-conscious virtue |
...
| inverse| opposite in order, nature, or effect; something that is the opposite of something else|
| pronounced| strongly marked|
| rebellious| of, relating to, or characteristic of a rebel or rebellion|
...
| theatrical|connected with the theater; exaggerated in order to attract attention |
